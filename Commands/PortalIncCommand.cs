...
public class PortalIncCommand : Command
{
    ...
    public override string ToString()
    {
        ...
        if (_beforChange != null)
        {
            returnText = $"{_commandIndex}; Portal Inc [{_point.X},{_point.Y}] Number: {_beforChange.Number} -> {_afterChange.Number}, " +
        ...
        {
            returnText = $"{_commandIndex}; Portal Inc [{_point.X},{_point.Y}] Number: null -> {_afterChange.Number}, " +
