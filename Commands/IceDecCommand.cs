...
public class IceDecCommand : Command
{
    ...
    public override string ToString()
    {
        ...
        if (_afterChange != null)
        {
            returnText = $"{_commandIndex}; Ice Dec [{_point.X},{_point.Y}] Number: {_beforChange.Number} -> {_afterChange.Number}, " +
        ...
        {
            returnText = $"{_commandIndex}; Ice Dec [{_point.X},{_point.Y}] Number: {_beforChange.Number} -> null, " +
