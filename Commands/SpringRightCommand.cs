...
public class SpringRightCommand : Command
{
    ...
    public SpringRightCommand(List<Command> commands, List<FloorTile> floorTiles, Point point, int commandIndex, int floorTileIndex)
    {
        _commands = commands;
        _point = point;
    ...
    public override void Execute()
    {
        ...
        {
            _floorTiles[_floorTileIndex].Spring = SpringDirection.Right;
        }
        _afterChange = new FloorTile
        {
            PosX = _floorTiles[_floorTileIndex].PosX,
