...
public class FinishCommand : Command
{
    ...
    public FinishCommand(List<Command> commands, List<FloorTile> floorTiles, Point point, int commandIndex, int floorTileIndex)
    {
        _commands = commands;
        _point = point;
    ...
    public override void Undo()
    {
        ...
        {
            _floorTiles[_floorTileIndex].PosX = _beforChange.PosX;
            _floorTiles[_floorTileIndex].PosY = _beforChange.PosY;
